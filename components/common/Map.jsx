...
export default function Map() {
  ...
  return (
    <>
      <a
        href="#"
        className={`map-section ${mapOpen ? "js-active" : ""}`}
      ...
      >
        <div className="map-toggle wow fadeInUpShort" aria-hidden="true">
          ...
          <div className="mt-text">
            <div onClick={toggleMap} className="mt-open">
              Open the map <i className="mt-open-icon"></i>
            </div>
            <div onClick={toggleMap} className="mt-close">
      ...
      {mapOpen && ( // Render iframe only when mapOpen is true
        <iframe
