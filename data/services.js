...
export const services6 = [
  {
    width: 24,
    height: 24,
    path: "M20 11.5H3V20.5C3 21.0523 3.44772 21.5 4 21.5H20C20.5523 21.5 21 21.0523 21 20.5V12.5C21 11.9477 20.5523 11.5 20 11.5Z M1.59998 7.40002L17.5747 1.58568C18.0937 1.39679 18.6676 1.66438 18.8565 2.18335L19.5405 4.06274C19.7294 4.58172 19.4618 5.15556 18.9428 5.34445L2.96806 11.1588L1.59998 7.40002Z M15.6954 2.26973L15.1841 6.71254 M11.9366 3.6378L11.4253 8.08061 M8.17785 5.00589L7.66654 9.4487 M4.41906 6.37397L3.90775 10.8168",
    title: "Post Production",
    text: "Post production refers to the processes that take place after the initial filming, including editing, sound design, and visual effects to enhance the final output.",
  },
  {
    width: 32,
    height: 32,
    path: "M25,2H22a2,2,0,0,0-2-2H12a2,2,0,0,0-2,2H7A3,3,0,0,0,4,5V29a3,3,0,0,0,3,3H25a3,3,0,0,0,3-3V5A3,3,0,0,0,25,2ZM12,2h8V3h0V4H12ZM26,29a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V5A1,1,0,0,1,7,4h3a2,2,0,0,0,2,2h8a2,2,0,0,0,2-2h3a1,1,0,0,1,1,1Z M15,19a1,1,0,0,0,2,0v-.18A3,3,0,0,0,16,13a1,1,0,0,1,0-2h2a1,1,0,0,0,0-2H17a1,1,0,0,0-2,0v.18A3,3,0,0,0,16,15a1,1,0,0,1,0,2H14a1,1,0,0,0,0,2Z M11,22H9a1,1,0,0,0,0,2h2a1,1,0,0,0,0-2Z M23,22H15a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z M11,26H9a1,1,0,0,0,0,2h2a1,1,0,0,0,0-2Z M23,26H15a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z",
    title: "Commercial",
    text: "Unlock the full potential of your content with our post production services. We specialize in editing, sound design, color grading, and visual effects for a seamless finish.",
  },
