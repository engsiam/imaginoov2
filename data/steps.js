...
export const stepsItems2 = [
  {
    ...
    title: "Market Expertise, Algorithm Precision",
    description:
      "We don’t just guess what works—we apply insights from audience data and algorithms to ensure your campaigns get seen and shared..",
  },
  {
    dataWowDuration: "1.2s",
    dataWowDelay: "0.15s",
    ...
    title: "Cost-Effective Creativity",
    description:
      "Our AI-enhanced approach allows us to create 100+ localized content pieces for a fraction of traditional production costs, helping you scale smarter.",
  },
  {
    dataWowDuration: "1.2s",
    dataWowDelay: "0.3s",
    ...
    description:
      "We use AI to accelerate creativity, not replace it, ensuring your content feels personal and authentic..",
  },
  {
    dataWowDuration: "1.2s",
    dataWowDelay: "0.45s",
    label: "Step 4",
    iconPath:
      "M22 0h-20c-1.104 0-2 .896-2 2v20c0 1.104.896 2 2 2h20c1.104 0 2-.896 2-2v-20c0-1.104-.896-2-2-2zm-1 18.586l-3.293-3.293-2.293 2.293-1.414-1.414 2.293-2.293-3.293-3.293 1.414-1.414 3.293 3.293 2.293-2.293 1.414 1.414-2.293 2.293 3.293 3.293-1.414 1.414z",
    title: "Collaborative from Start to Finish",
    description:
      "We work alongside you at every step to ensure your brand’s vision comes to life in the most impactful way..",
  }
];
